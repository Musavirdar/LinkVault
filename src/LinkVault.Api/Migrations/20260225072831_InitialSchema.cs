        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataExportPolicy = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is2FASetupComplete = table.Column<bool>(type: "boolean", nullable: false),
                    SsoProvider = table.Column<string>(type: "text", nullable: true),
                    SsoSubject = table.Column<string>(type: "text", nullable: true),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Directories_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkDirectories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LinkDirectories_LinkDirectories_ParentId",
                        column: x => x.ParentId,
                        principalTable: "LinkDirectories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LinkDirectories_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_Directories_DirectoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UserDirectoryId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Links", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Links_Directories_UserDirectoryId",
                        column: x => x.UserDirectoryId,
                        principalTable: "Directories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Links_LinkDirectories_DirectoryId",
                        column: x => x.DirectoryId,
                        principalTable: "LinkDirectories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_Files_FileItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExportRequests_Files_FileItemId",
                        column: x => x.FileItemId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExportRequests_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExportRequests_Users_RequestedById",
                        column: x => x.RequestedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExportRequests_Users_ReviewedById",
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "Description", "IsSystemRole", "Name", "OrganizationId" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 2, 25, 7, 28, 30, 754, DateTimeKind.Utc).AddTicks(5056), "Organization Administrator", true, "Admin", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 2, 25, 7, 28, 30, 754, DateTimeKind.Utc).AddTicks(5058), "Organization Employee", true, "Employee", null }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_FileItemId",
                table: "AuditLogs",
                column: "FileItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_DirectoryId",
                table: "ChatMessages",
                column: "DirectoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Directories_OrganizationId",
                table: "Directories",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExportRequests_FileItemId",
                table: "ExportRequests",
                column: "FileItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ExportRequests_OrganizationId",
                table: "ExportRequests",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExportRequests_ReviewedById",
                table: "ExportRequests",
                column: "ReviewedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LinkDirectories_OwnerId",
                table: "LinkDirectories",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_LinkDirectories_ParentId",
                table: "LinkDirectories",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_Links_DirectoryId",
                table: "Links",
                column: "DirectoryId");
